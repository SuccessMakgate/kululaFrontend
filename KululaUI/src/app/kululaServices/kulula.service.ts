...
import {  FlightSearch, carhire, schedule, addFlight, register, ClientDetails, login, payment, Memberpayment, addCar, seatbook, ChangePassword, Traveller } from './kulula.model';
...
export class KululaService {
 ...
 AddTravellers(travellers:Traveller){
   const data:Traveller={
     IdNumber:travellers.IdNumber,
     FirstName:travellers.FirstName,
     LastName:travellers.LastName,
     Address:travellers.Address,
     PhoneNo:travellers.PhoneNo,
     Email:travellers.Email,
